...
Usage: uv run --with pyyaml python cpu/tests/check-alerts.py --promtool /path/to/promtool
"""
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="cpu-alert-tests-") as directory:
        directory = Path(directory)
        rules = directory / "cpu-rules.yaml"
