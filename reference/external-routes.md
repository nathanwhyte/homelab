...
| `risk.nathanwhyte.dev`                  | `rails.equal-risk:3000`    | Rails application                              | Dedicated Cloudflare `eqrsk` tunnel; provider routing is recorded in [`cloudflare/namespace-tunnels/eqrsk-routing.yaml`](../cloudflare/namespace-tunnels/eqrsk-routing.yaml) |
