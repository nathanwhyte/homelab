...
# BUG-1176 extract, BUG-1177 ChatLog, BUG-1174 S3 cache and BUG-1180 memory guard
# patches, one loader).
# The test stack builds its own ConfigMap (ov-nav-patch) from the same six files via its
