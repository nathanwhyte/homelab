...
# canonical sources in viking/manifests/test/nav-patch/ (IMPR-1185 nav patch and
# BUG-1176 extract patch, one loader). The test stack builds its own ConfigMap
# (ov-nav-patch) from the same three files via its
