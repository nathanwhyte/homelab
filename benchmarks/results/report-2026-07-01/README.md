...
|---|---|---|---|---|---|---|
| Cluster (timmy) | RX 9070 XT 16 GB | `gemma4:12b-it-qat` | 0.31.1-rocm | 6 / 8 | 16K–32K | `mixed_mem0`, `agentic` |
...
| `OLLAMA_LOAD_TIMEOUT` | 15m | **15m** | ROCm/PVC loads can be slow; no downside. |
...
1. Complete remaining pop configs overnight or on a headless Mac.
2. Evaluate `OLLAMA_KEEP_ALIVE=-1` on the cluster.
