...
| Model                     | Verdict                                                                  | Next                                                                                   |
| ------------------------- | ------------------------------------------------------------------------ | -------------------------------------------------------------------------------------- |
| `qwen3.5:9b-q4_K_M`       | **keep — leading candidate**                                             | rerun done (15/20, +2); slot probe (`n_seq_max` on 0.33.1) before cohabitation         |
| `gemma4:e4b-it-qat`       | **keep** — smallest editor with zero token loss, fastest                 | rerun done (14/20, +2); IDEA-1084 parser re-test still applies if tool calling is used |
